...
public class OtherAdapter extends BaseSwipeAdapter implements Filterable {
   ...
   /* public GridViewAdapter(Context mContext) {
    ...
    public OtherAdapter(Context mContext, int layoutResourceId, ArrayList<OrderParent.OrderArrayDetails> kit) {
        // mkit = kit;
        this.mContext = mContext;
        this.mkit = kit;
...
//        final Order data = mkit.get(position);
    ...
    public void fillValues(int position, final View convertView) {
        ...
        ImageView imgVwSwipePickup = (ImageView)convertView.findViewById(R.id.imgVwSwipePickup);
...
/*
       ...
       ;
        ...
        try {
            ...
            txtVwStatus.setText("Order");

            txtVwStatus1.setText("Order");

         /*   if (data.Status_id==2) {


                //txtVwStatus.setBackgroundResource(R.drawable.backgroundgreen);

                //txtVwStatus1.setBackgroundResource(R.drawable.backgroundgreen);
                imgVwPickup.setBackgroundResource(R.drawable.cooking);
                imgVwSwipePickup.setBackgroundResource(R.drawable.cooking);
            }
            else
            {
                imgVwPickup.setBackgroundResource(R.drawable.cooking);
